        ...
        if(mysqli_num_rows($check)==1){
         ...
         ?>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <font color='red'><?php echo $neg; ?></font>
                            </td>
                        </tr>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Phone :</i></i></td>
                            <td><?php echo $phone;?> <font color='green'><i class="fa fa-whatsapp"></i></font>
                                <font color='black'><i class="fa fa-phone"></i></font>
                    ...
                    <form method="post" id="showme" action="detail.php?u=<?php echo $ads_id; ?>">
                        ...
                        <div class="form-row">
                            <input type="email" name="email" placeholder="Your Email"
                                style="border:none; border-color: #0a0a0a; border-style: solid; border-width: 2px; margin-bottom: 10px;">
                        </div>
                        ...
                        <div class="form-row">
                            <textarea name="texxt" placeholder="Content" height="200px"
                                style="font-size: 10px; width: 143px; border:none; border-color: #0a0a0a; border-style: solid; border-width: 2px;"></textarea>
                        </div><br>
...
?>
      ...
      <!---div1 ends--->
        ...
        <div class=" grid_4">
                            ...
                            <div style="width: 200%" ; class="grid_12">
...
<a href='detail.php?u=$iid'><div class='mimg'>
    ...
    ";
				...
				?>
                                ...
                                <div class='grid_12'>
                                    <center><a href='ads.php'>See more...</a></center>
                                </div>
                            </div>
                        </div>
