	...
	if($image_resource){
		...
		$photo=$destination_folder.'/'.$image_name ;
			//$query=mysql_query("INSERT INTO image(img) VALUE ('$image_name')");
                          ...
                          $profile_update=mysqli_query($con,"UPDATE sell SET title='$title',prize='$prize', description='$desc', negotiable='$negot', category='$cat', sub_category='$subcat', item_pix='$photo' WHERE id='$idd'");
