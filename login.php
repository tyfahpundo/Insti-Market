...
AND password='$pass_md5'") or die(mysqli_error($con));
...
$college = mysqli_real_escape_string($con,$college);
	...
	if($name =="" || $pass=="" ||$pass2=="" || $uname =="" || $email=="" || $mobile=="" || $college=="")
        {
...
//
    ...
    if (mysqli_num_rows($check)>=1)
    {
       echo "Username already taken";
        ...
        {
      $pass_md5=md5($pass);
		$insert = "INSERT INTO members (name,user,password,phone,email,college)
VALUES ('$name','$uname','$pass_md5','$mobile','$email','$college')";
		mysqli_query($con,$insert) or die('Cannot add record '.mysqli_error($con));
